...
[![CI](https://github.com/hypernetix/dnaspec/actions/workflows/ci.yml/badge.svg)](https://github.com/hypernetix/dnaspec/actions/workflows/ci.yml)
...
Download the latest release for your platform from [GitHub Releases](https://github.com/hypernetix/dnaspec/releases):
...
```bash
go install github.com/hypernetix/dnaspec/cmd/dnaspec@latest
```
